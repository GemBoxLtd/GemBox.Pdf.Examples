    ...
    Sub Example3()
        ...
        Using document = New PdfDocument()
            ...
            path.
                ...
                LineTo(center.X, center.Y + radius). ' Continue to the point in the upper-center.
                CloseSubpath() ' End with the starting point.
            ' Stroke path (to visualize its bounds) and set it as a clipping path using non-zero winding number rule.
            format = path.Format
            format.Fill.IsApplied = False
            format.Stroke.IsApplied = True
            format.Clip.IsApplied = True
            ...
            ' Image will be clipped to the star like path using nonzero winding number rule.
