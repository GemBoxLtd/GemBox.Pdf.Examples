    ...
    Sub Main()
        ...
        Using document = New PdfDocument()
            ...
            Using labelText = New PdfFormattedText()
                ...
                ' Add 'Gender', 'Male', and 'Female' labels and two 'Gender' radio button fields with choices 'Male' and 'Female'.
                y -= 40
                labelText.Clear()
                ...
                ' Add 'Married' label and 'Married' check box field with export value 'Yes'.
                y -= 40
                labelText.Clear()
                labelText.TextAlignment = PdfTextAlignment.Right
                ...
                ' Add 'City' label and 'City' combo box field that contains several predefined values and allows user to enter a custom value.
                y -= 40
                labelText.Clear()
                ...
                ' Add 'Language' label and 'Language' list box field that contains several predefined values and allows user to select more than one value.
                y -= 40
                labelText.Clear()
                ...
                ' Add 'Notes' label and 'Notes' text field that may contain multiple lines of text.
                y -= 80
                labelText.Clear()
                ...
                ' Add 'ResetButton' button field with an action that resets all form fields to their default values.
                y -= 100
